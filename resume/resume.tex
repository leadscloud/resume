...
\documentclass[letterpaper,11pt,fontset=none]{ctexart}
...
\section{\textbf{注意事项}}
  \input{../components/extend}

\cfoot{\changefont Page \thepage\ of \pageref{LastPage}\ - 本简历使用LaTex生成}
\end{document}
